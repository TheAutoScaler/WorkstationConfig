...
Fetch `brew_formulae_macos`, `brew_casks`, `uv_tools`, and `npm_tools`:
...
curl -O \
    https://raw.githubusercontent.com/TheAutoScaler/WorkstationConfig/main/npm_tools
```

Install software using Homebrew, uv, and npm:
